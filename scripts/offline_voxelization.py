...
#This script mirrors what the Dataset is already doing on the fly in training
#First step is to import all of the existing utilities to avoid duplicating code

from src.learning.dataloader.events_to_voxel.raw_to_clip import *
from src.learning.dataloader.events_to_voxel.utils import *
from src.learning.dataloader.events_to_voxel.reader import *
from src.learning.dataloader.representation.event_denoising import *
from src.learning.dataloader.representation.event_slicer import *
from src.learning.dataloader.representation.voxel_grid import *
...
class VoxelProcessor():
    ...
    def __init__(self, 
        ...
        for seq_path in sequence_dirs:
            ...
            if not (gt_poses_fn.exists() and events_file.exists()):
                continue
